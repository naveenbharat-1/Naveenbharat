...
- Activation steps:
  1. Sign up at https://capgo.app, create app for `com.naveenbharat.app`
...
adb shell am start -W -a android.intent.action.VIEW \
  -d "https://naveenbharat.vercel.app/dashboard" com.naveenbharat.app

# iOS simulator
xcrun simctl openurl booted "https://naveenbharat.vercel.app/dashboard"
```
