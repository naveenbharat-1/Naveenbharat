    ...
    <nav className="fixed bottom-0 left-0 right-0 bg-card border-t border-border z-30 md:hidden safe-area-bottom nb-hide-on-kb">
      <div className="flex items-center justify-around h-16 px-1">
          ...
          return (
            ...
            >
              ...
              <img
                ...
                decoding="async"
              />
              <span className={`relative text-[9px] font-medium ${active ? "text-accent" : "text-muted-foreground"}`}>
                {label}
              </span>
            </button>
          );
        ...
        >
          ...
          />
          <span className={`relative text-[9px] font-medium ${isActive("/downloads") ? "text-accent" : "text-muted-foreground"}`}>
            Downloads
          </span>
        </button>
        ...
        {(isTeacher || isAdmin) && (
          ...
          >
            ...
            />
            <span className={`relative text-[9px] font-medium ${isActive("/admin") ? "text-accent" : "text-muted-foreground"}`}>
              Admin
            </span>
          </button>
        )}
        ...
        >
          ...
          />
          <span className={`relative text-[9px] font-medium ${isActive("/profile") ? "text-accent" : "text-muted-foreground"}`}>
            Profile
          </span>
        </button>
      </div>
