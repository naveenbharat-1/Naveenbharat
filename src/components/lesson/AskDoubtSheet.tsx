          ...
          <div className="px-3 pt-3 pb-2">
            <div className="rounded-2xl border border-border bg-muted/30 px-3 pt-2 pb-2 shadow-inner">
              ...
              <textarea
                ...
                rows={2}
                disabled={chatBusy}
                className="mt-2 w-full resize-none bg-transparent text-sm outline-none placeholder:text-muted-foreground/70 max-h-40 py-1"
              />
              <div className="flex items-center justify-between pt-1">
                <button
                  ...
                  className="h-8 w-8 rounded-full flex items-center justify-center text-muted-foreground/60"
                >
                ...
                <button
                  ...
                  className="h-10 px-5 rounded-full inline-flex items-center gap-2 bg-gradient-to-r from-primary to-primary/80 text-primary-foreground disabled:from-muted disabled:to-muted disabled:text-muted-foreground transition-all shadow-md hover:shadow-lg font-semibold text-sm"
                >
                  {chatBusy ? (
