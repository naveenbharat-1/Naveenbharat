...
import { ArrowLeft, WifiOff, HardDrive, Plus, Loader2 } from "lucide-react";
...
const Library = () => {
  ...
  return (
    <div className="min-h-screen bg-background pb-20 safe-area-bottom">
      <header className="safe-area-top sticky top-0 z-30 flex min-h-[52px] items-center gap-3 border-b bg-card px-4 shadow-sm">
